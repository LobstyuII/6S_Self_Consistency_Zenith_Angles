...
class ExperimentConfig:
    ...
    # 实验参数空间
    PARAM_SPACE = {
        'sza': np.arange(0, 86, 15),  # 太阳天顶角 (0-85°, 5°步长)
        'vza': np.arange(0, 76, 15),  # 观测天顶角 (0-75°, 5°步长)
        'raa': [0, 90],  # 相对方位角
        'rho_true': [0.1, 0.2, 0.4],  # 地表真实反射率
        'aod550': [0.1, 0.3, 0.5],  # 550nm气溶胶光学厚度
        # 'aod550': [0.3],  # 550nm气溶胶光学厚度
    ...
    EXPERIMENT_MODES = {
        'full': 'Full parameter simulation',
        'single_factor': 'Single factor sensitivity test',
        'multi_factor': 'Multi-factor synergistic sensitivity test',
        'airmass_only': 'Airmass only test'
    }
