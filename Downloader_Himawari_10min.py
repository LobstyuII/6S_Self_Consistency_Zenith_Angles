...
# 文件日志处理器
file_handler = logging.FileHandler('../h8_downloader_10min.log')
...
def get_date_range():
    """获取用户输入的日期范围"""
    default_start = "20200501"
    default_end = "20200507"
...
def get_satellite_prefix(date):
    ...
    return "H08" if date < datetime.date(2022, 12, 13) else "H09"
...
def initialize_vacant_file():
    ...
    vacant_file_path = os.path.join(data_dir_path, f"H8{DATA_TYPE}_vacant_10min.csv")
